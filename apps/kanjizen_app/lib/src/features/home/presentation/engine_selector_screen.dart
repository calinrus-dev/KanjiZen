    ...
    if (node is MecaInputNode) {
      ...
      return ConstrainedBox(
        constraints: BoxConstraints(
          minHeight: localCanvasHeight * 0.3,
          maxHeight: localCanvasHeight * 0.7,
        ),
      ...
      return ConstrainedBox(
        constraints: BoxConstraints(
          minHeight: localCanvasHeight * 0.25,
          maxHeight: localCanvasHeight * 0.6,
        ),
    ...
    return ConstrainedBox(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final knobSize = (h * 0.65).clamp(10.0, h - 2);
          return GestureDetector(
