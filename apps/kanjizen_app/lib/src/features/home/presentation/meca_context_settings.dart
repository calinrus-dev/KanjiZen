    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final rawWidth = constraints.maxWidth.isFinite && constraints.maxWidth > 0
            ...
            : 56.0;
        final width = rawWidth.clamp(40.0, 56.0);
        final height = width * 0.5;
        final knobSize = height * 0.65;
        final knobOffset = value ? width - knobSize - 2 : 2.0;
...
class _CyberSegmentedControl<T> extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        final rawMaxWidth = constraints.maxWidth.isFinite && constraints.maxWidth > 0
            ? constraints.maxWidth
            : 210.0;
        final maxWidth = rawMaxWidth.clamp(120.0, 280.0);
        final itemWidth = maxWidth / children.length;
