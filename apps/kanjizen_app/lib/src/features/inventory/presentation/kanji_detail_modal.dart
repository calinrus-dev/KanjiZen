  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(color: widget.accent.withValues(alpha: 0.5)),
        ),
      ),
      child: Column(
        children: [
            ...
            child: Row(
              ...
              children: [
                Text(
                  isLocked
                      ? 'ESTADO: BLOQUEADO'
                      : 'ESTADO: ACTIVO [TIER $tierName]',
                  style: TextStyle(
                    color: isLocked ? CyberTheme.textNeutral : widget.accent,
                    fontFamily: 'Courier',
                    fontSize: 12,
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _MetaChip(
                      'RADICAL',
                      k.radical.isNotEmpty ? k.radical : '?',
                      widget.accent,
                    ),
                  ],
                ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: OutlinedButton(
                          ...
                          style: OutlinedButton.styleFrom(
                            foregroundColor: CyberTheme.errorRed,
                            side: const BorderSide(color: CyberTheme.errorRed),
                          ),
                          child: const Text(
                            'BLOQUEAR',
                            style: TextStyle(
