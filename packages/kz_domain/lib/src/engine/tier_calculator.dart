...
class TierCalculator {
  ...
  static int encodeAttempt({required bool isCorrect, required bool isDoubleStroke, required int responseMs}) {
  ...
  static String calculateTier({
    ...
    if ((candidateTier == 'C' || candidateTier == 'B') && totalKanaUnlocked < 23) {
      candidateTier = 'D';
    }
  ...
  static double calculateEffectiveMs({
    ...
    final hasDakuten = character.contains('゛') || character.contains('゜') || 
